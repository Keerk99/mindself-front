...
export default function Footer() {
  return (
    <footer className="text-white">
      <div className="bg-[#1b4b0e]">
        <div className="my-0 mx-auto py-6 px-40 max-w-[1900px]">
      ...
      <div className="bg-[#1f291c]">
        <div className="my-0 mx-auto py-4 px-40 max-w-[1900px]">
